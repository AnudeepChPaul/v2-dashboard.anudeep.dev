    ...
    columns: {
        ...
        items: [{
            ...
            renderer: function (value, metaData) {
                switch (value) {
                    case 1:
                        return '<span class="dash-notification-record fa fa-exclamation"></span>';
                    case 2:
                        return '<span class="dash-notification-record fa fa-angle-double-up"></span>';
                    case 3:
                        return '<span class="dash-notification-record fa fa-chevron-down"></span>';
                }
            }
        }, {
            header: 'Date',
